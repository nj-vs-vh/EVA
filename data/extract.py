...
def dump_datafile(dataset: DatasetDef, skip_existing: bool, combo_level=0, energy_convert_level=0):
    ...
    items = [i for i, sub in enumerate(tab["sub_exp"]) if dataset.sub_exp_name is None or sub == dataset.sub_exp_name]
    if not items:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--new-only", action="store_true", help="Skip datasets that are already downloaded", default=False)
    ...
    datasets = [
        ...
        DatasetDef("H", "ETOT", "NUCLEON", "NUCLEON-KLEM (2015/07-2017/06)", "NUCLEON_H_energy.txt"),   
        ...
        DatasetDef("He", "EKN", "CREAM", "CREAM-I+III (2004+2007)", "CREAM_He_kEnergyPerNucleon.txt"),   
        ...
        DatasetDef("C", "EKN", "CREAM", "CREAM-II (2005/12-2006/01)", "CREAM_C_kEnergyPerNucleon.txt"),   
        ...
        DatasetDef("O", "EKN", "CREAM", "CREAM-II (2005/12-2006/01)", "CREAM_O_kEnergyPerNucleon.txt"),   
        DatasetDef("Mg", "R", "AMS02", "AMS02 (2011/05-2018/05)", "AMS-02_Mg_rigidity.txt"),
        DatasetDef("Mg", "EKN", "CREAM", "CREAM-II (2005/12-2006/01)", "CREAM_Mg_kEnergyPerNucleon.txt"),   
        DatasetDef("Si", "R", "AMS02", "AMS02 (2011/05-2018/05)", "AMS-02_Si_rigidity.txt"),
        DatasetDef("Si", "EKN", "CREAM", "CREAM-II (2005/12-2006/01)", "CREAM_Si_kEnergyPerNucleon.txt"),   
        DatasetDef("Fe", "R", "AMS02", "AMS02 (2011/05-2019/10)", "AMS-02_Fe_rigidity.txt"),
        DatasetDef("Fe", "EKN", "CALET", "CALET (2016/01-2020/05)", "CALET_Fe_kEnergyPerNucleon.txt"),
        DatasetDef("Fe", "EKN", "CREAM", "CREAM-II (2005/12-2006/01)", "CREAM_Fe_kEnergyPerNucleon.txt"),
        DatasetDef("AllParticles", "ETOT", "NUCLEON", "NUCLEON-KLEM (2015/07-2017/06)", "NUCLEON_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "GAMMA", "GAMMA (2003/01-2007/12) SIBYLL", "GAMMA_SIBYLL_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "HAWC", "HAWC (2018-2019) QGSJet-II-04", "HAWC_QGSJET-II-04_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "TALE", "TALE (2014/06/-2016/03) QGSJet-II-03", "TALE_QGSJET-II-04_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "TUNKA", "TUNKA-133 Array (2009/10-2012/04) QGSJet01", "TUNKA-133_QGSJET-01_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "KASCADE", "KASCADE (1996/10-2002/01) QGSJet01", "KASCADE_QGSJET-01_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "KASCADE", "KASCADE (1996/10-2002/01) SIBYLL 2.1", "KASCADE_SIBYLL_21_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "KASCADE", "KASCADE-Grande (2003/01-2009/03) QGSJet-II-04", "KGRANDE_QGSJET-II-04_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "KASCADE", "KASCADE-Grande (2003/12-2011/10) SIBYLL2.3", "KGRANDE_SIBYLL_23_all_energy.txt"),        
        DatasetDef("AllParticles", "ETOT", "IceTop", "IceTop (2016/05-2017/04) QGSJet-II-04", "ICETOP_QGSJET-II-04_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "IceTop", "IceTop (2016/05-2017/04) SIBYLL2.1", "ICETOP_SIBYLL_21_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "IceCube", "IceCube+IceTop (2010/06-2013/05) SIBYLL2.1", "ICECUBE_SIBYLL_21_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "Auger", "Auger SD750+SD1500 (2014/01-2018/08)", "AUGER_all_energy.txt"),
        DatasetDef("AllParticles", "ETOT", "Telescope", "Telescope Array Hybrid (2008/01-2015/05)", "TA_all_energy.txt"),
        DatasetDef("H-He-group", "ETOT", "Tibet", "Tibet III (2000/11-2004/10) QGSJet01", "TIBET_light_energy.txt"),
        DatasetDef("H/He", "R", "AMS02", "AMS02 (2011/05-2018/05)", "AMS-02_p_He_ratio_rigidity.txt"),
        DatasetDef("H/He", "R", "CALET", "CALET (2015/10-2022/04)", "CALET_p_He_ratio_rigidity.txt"),
        DatasetDef("H/He", "R", "NUCLEON-KLEM", "NUCLEON-KLEM (2015/07-2017/06)", "NUCLEON_p_He_ratio_rigidity.txt"),
    ]
